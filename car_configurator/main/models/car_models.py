...
class CarModel(models.Model):
    ...
    base_price = models.DecimalField(max_digits=10, decimal_places=2, default=20.000, null=True, blank=True)
    
    def __str__(self):
        return f"{self.company_name} - {self.model_name} (by {self.created_by.username})"
